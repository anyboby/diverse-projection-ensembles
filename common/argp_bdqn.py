...
def read_args():
    ...
    # rainbow settings
    parser.add_argument('--network_arch', type=str, default='impala_bdqn:2',
                        help='which model architecture to use for the q-network; one of "nature", "dueling", "impala_small", "impala_bdqn:2" (c is the number of channels in impala large)')
