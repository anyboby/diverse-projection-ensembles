...
def read_args():
    ...
    # rainbow settings
    parser.add_argument('--network_arch', type=str, default='impala_ids:2',
                        help='which model architecture to use for the q-network; one of "impala_ids:c" (c is the number of channels in impala large)')
    parser.add_argument('--ensemble_size', type=int, default=10, help='Number of networks to append to CNN extractor.')
    parser.add_argument('--prior_beta', type=float, default=1.0, help='prior beta for randomized prior functions')    
    parser.add_argument('--n_heads', type=int, default=101, help='Number of atoms to represent categorical distribution.')
    parser.add_argument('--q_min', type=float, default=-10.0, help='minimal q values for categorical support')
    parser.add_argument('--q_max', type=float, default=10.0, help='maximal q values for categorical support')
    ...
    parser.add_argument('--init_beta', type=float, default=0.1, help='beta for ucb scale')
