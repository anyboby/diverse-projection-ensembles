...
from common import argp_rainbow
...
if __name__ == '__main__':
    args, wandb_log_config = argp_rainbow.read_args()
    ...
    wandb.init(project='rainbow', save_code=True, dir=str(wandb_dir), config=dict(**wandb_log_config, log_version=100),
    ...
    for game_frame in t:
        ...
        if game_frame % (2_900_000-(2_900_000 % args.parallel_envs)) == 0 and game_frame > 0:
